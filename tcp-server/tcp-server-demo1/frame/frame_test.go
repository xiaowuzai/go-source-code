...
func TestEncode(t *testing.T) {
	...
	if err != nil {
		t.Errorf("Encode: want nil, actual %s", err.Error())
	}
...
func TestDecode(t *testing.T) {
	...
	if err != nil {
		t.Errorf("Decode: want nil, actual %s", err.Error())
	}
...
func TestDecodeWithReadFail(t *testing.T) {
	...
	if err == nil {
		t.Errorf("1 want non-nil, actual nil")
	}
	...
	if err == nil {
		t.Errorf("2 want non-nil, actual nil")
	}
}
